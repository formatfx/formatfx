...
[`samyost/formatfx`](https://github.com/samyost/formatfx) or contact the author.

---

## Contributors

FormatFX accepts contributions under an inbound=outbound model plus a grant that lets
the author offer the commercial license above. See [`CONTRIBUTING.md`](./CONTRIBUTING.md)
if present, or open a discussion before your first substantial PR. This keeps the
project's dual-license model intact so the open track stays sustainably funded.
