  ...
  <main class="wb-layout" id="wb-layout">
    <aside class="wb-pane wb-pane-palette" id="wb-pane-palette">
      <h2><span class="wb-pane-title">Palette</span>
        <button id="wb-palette-toggle" title="Collapse to icons — drag still works; hover for names" aria-label="Collapse palette">⮜</button>
      </h2>
    ...
    <aside class="wb-pane wb-pane-tree" id="wb-pane-tree">
      ...
      <h2><span>Structure</span>
        <button id="wb-tree-peek" title="Auto-hide: shrink Structure to a rail; hover the rail to open it, click anywhere else to close" aria-label="Auto-hide Structure">📌</button>
      </h2>
      <div id="wb-tree" class="wb-tree-split">
        <section class="wb-tree-sec" id="wb-tree-sec-view">
          <div class="wb-tree-sec-head" id="wb-tree-view-head" title="The view formatter on the canvas — click to collapse">
            <button class="wb-tree-sec-min" id="wb-tree-view-min" title="Collapse / expand the view formatter" aria-label="Collapse view formatter">▾</button>
        ...
        <section class="wb-tree-sec" id="wb-tree-sec-cols">
          <div class="wb-tree-sec-head" id="wb-tree-cols-head" title="Column formatters in the workspace — click to collapse">
            <button class="wb-tree-sec-min" id="wb-tree-cols-min" title="Collapse / expand the column formatters" aria-label="Collapse column formatters">▾</button>
      ...
      <section class="wb-data-dock" id="wb-data-dock">
        <div class="wb-data-dock-head" id="wb-data-dock-head" title="Mock rows &amp; columns — click the title to collapse">
          ...
          <span class="wb-data-dock-actions">
            <button id="wb-data-min" title="Collapse / expand the data panel" aria-label="Collapse data panel">▾</button>
            <button id="wb-data-max" title="Maximize the data panel" aria-label="Maximize data panel">⛶</button>
          </span>
        </div>
    ...
    <aside class="wb-pane wb-pane-side" id="wb-pane-side">
      ...
      <nav class="wb-tabs">
        ...
        <button id="wb-side-peek" title="Auto-hide: shrink this pane to a rail; hover the rail to open it, click anywhere else to close" aria-label="Auto-hide side panel">📌</button>
        <button id="wb-side-max" title="Maximize this pane — room for editing JSON" aria-label="Maximize side panel">⛶</button>
      </nav>
